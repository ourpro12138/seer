...
//LieHuoHou::LieHuoHou(int i,int j)
//{
//    this->i = i; this->j = j;
//    this->width = 130;this->height=160;

//    hp=250,atk=40,prepareTime=150,atkcounter=150;
//    standTime=64; standcounter=0; coolTime=0;coolcounter=0;
//    name="LieHuoHou";
//    atkmovie=new QMovie(":/partner/resource/partner/stand_liehuohou.gif");
//    atkmovie->start();
...
//        delete atkmovie;
//}
//bool LieHuoHou::collidesWithItem(const QGraphicsItem *other, Qt::ItemSelectionMode mode) const
//{
//    Q_UNUSED(mode);
...
//void LieHuoHou::advance(int phase)
//{
//    if(!phase)
//        return;
//    update();
